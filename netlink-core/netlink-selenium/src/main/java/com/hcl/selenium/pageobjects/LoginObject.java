...
public class LoginObject extends BasePageObject {
	...
	@Test
	@Parameters({ "userName", "password", "driverName"})
	public void loginInputs(String userName,String password,final String driverName) throws Exception {
		
		//String userName=it.getAttribute("userName").toString();
		//String password=it.getAttribute("password").toString();
	
		
		
		WebDriver driver=null;
		try{
		driver =Browser.getNewWebDriver("webdriver.chrome.driver", "d://chromedriver.exe", "http://localhost:39379/NetLink/");
