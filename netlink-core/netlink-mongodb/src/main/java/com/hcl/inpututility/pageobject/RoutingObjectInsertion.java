...
public class RoutingObjectInsertion {
	...
	*/
		...
		xpaths1.setPageElement("XPATH_FOR_CREATE_ROUTING_NAME");
		...
		xpaths2.setPageElement("XPATH_FOR_CREATE_ROUTING_IDENTIFIER");
		...
		xpaths3.setPageElement("XPATH_FOR_CREATE_ROUTING_VERSION");
		...
		xpaths4.setPageElement("XPATH_FOR_CREATE_ROUTING_DESC");
		...
		xpaths5.setPageElement("XPATH_FOR_CREATE_ROUTING_BUTTON");
		...
		xpaths6.setPageElement("XPATH_FOR_CHANGE_ROUTING_BUTTON");
		...
		xpaths7.setPageElement("XPATH_FOR_DELETE_ROUTING_BUTTON");
		...
		xpaths8.setPageElement("XPATH_FOR_QUICKCHANGE_ROUTING_BUTTON");
		...
		xpaths9.setPageElement("XPATH_FOR_CHANGE_ROUTING_SITE_NAME");
		...
		xpaths10.setPageElement("XPATH_FOR_CHANGE_ROUTING_IDENTIFIER");
		...
		xpaths11.setPageElement("XPATH_FOR_CHANGE_ROUTING_VERSION");
		...
		xpaths12.setPageElement("XPATH_FOR_CHANGE_ROUTING_DESC");
		...
		xpaths13.setPageElement("XPATH_FOR_DELETE_ROUTING_SITENAME");
		...
		xpaths14.setPageElement("XPATH_FOR_DELETE_ROUTING_IDENTIFIER");
		...
		xpaths15.setPageElement("XPATH_FOR_DELETE_ROUTING_VERSION");
		...
		xpaths16.setPageElement("XPATH_FOR_QUICKCHANGE_ROUTING_NAME");
		...
		xpaths17.setPageElement("XPATH_FOR_QUICKCHANGE_ROUTING_IDENTIFIER");
		...
		xpaths18.setPageElement(" XPATH_FOR_QUICKCHANGE_ROUTING_VERSION");
